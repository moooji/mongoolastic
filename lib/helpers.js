...
function renderPopulationTree(schema, populationModels) {
  ...
  tree = !_.isEmpty(tree) ? tree : null;
  return tree;
}


/**
 * Render the index tree for a schema
 * @param {mongoose.Schema} schema
 * @param {Map<mongoose.Model>} populationModels
 */
function renderIndexTree(schema, populationModels) {
...
//module.exports.renderIndexTree = renderIndexTree;
